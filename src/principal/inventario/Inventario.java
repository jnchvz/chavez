...
public class Inventario {
	...
	public final ArrayList<Objeto> objetos; //objects

	public Inventario() {
		objetos = new ArrayList<Objeto>();  // inventory
	}

	public void recogerObjetos(final ContenedorObjetos co) { //picking objects
	...
	public boolean objetoExiste(final Objeto objeto) {  //boolean to know if the object exists
	...
	public ArrayList<Objeto> obtenerConsumibles() { // get consummibles 
	...
	public ArrayList<Objeto> obtenerArmas() { //get weapons
	...
	public Objeto obtenerObjeto(final int id) {  // get object
		for (Objeto objetoActual : objetos) {
