...
public abstract class Arma extends Objeto {
    ...
    public static HojaSprites hojaArmas = new HojaSprites(Constantes.RUTA_ARMAS, Constantes.LADO_SPRITE, false); // sprites sheets
    ...
    public Arma(final int id, final String nombre, final String descripcion, final int ataqueMinimo,
                ...
                final String rutaSonidoDisparo) { // weapon
    ...
    public void atacar(final ArrayList<Enemigo> enemigos) { // attack
        /*
        ...
        */
        ...
        float ataqueActual = obtenerAtaqueMedio(); // acual attack
    ...
    public boolean esAutomatica() { // is automatic
        return automatica;
    }

    public boolean esPenetrante() { // is penetrating
        return penetrante;
    }
}
