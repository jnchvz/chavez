...
public class EstructuraMenu { // menu structure

	public final Color COLOR_BANNER_SUPERIOR; // color banner
	...
	public final int MARGEN_HORIZONTAL_ETIQUETAS; // margin labels
	...
	public void dibujar(final Graphics g) { // draw
		DibujoDebug.dibujarRectanguloRelleno(g, BANNER_SUPERIOR, COLOR_BANNER_SUPERIOR); // superior banner
		DibujoDebug.dibujarRectanguloRelleno(g, BANNER_LATERAL, COLOR_BANNER_LATERAL); // lateral banner
		DibujoDebug.dibujarRectanguloRelleno(g, FONDO, COLOR_FONDO); // background color
	}
}