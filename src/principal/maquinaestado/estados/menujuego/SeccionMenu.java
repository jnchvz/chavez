...
public abstract class SeccionMenu { // menu section

	protected final String nombreSeccion; // name section
	protected final Rectangle etiquetaMenu; // label section
	protected final EstructuraMenu em; // menu structure

	protected final int margenGeneral = 8; // general margin
	...
	public abstract void actualizar(); // update

	public abstract void dibujar(final Graphics g, final SuperficieDibujo sd, final EstructuraMenu em); // draw
	...
	protected void dibujarLimitePeso(final Graphics g, EstructuraMenu em) { // draw limit weight
	...
	protected void dibujarTooltipPeso(final Graphics g, SuperficieDibujo sd, EstructuraMenu em) { // draw tooltip weight
	...
	public String obtenerNombreSeccion() { // get name section
		return nombreSeccion;
	}

	public Rectangle obtenerEtiquetaMenu() { // get label manu
		return etiquetaMenu;
	}

	public Rectangle obtenerEtiquetaMenuEscalada() { // get scaled label menu
		...
		return etiquetaEscalada; //scaled
	}
