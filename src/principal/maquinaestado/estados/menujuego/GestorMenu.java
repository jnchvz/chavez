...
public class GestorMenu implements EstadoJuego {
	...
	private final SuperficieDibujo sd; // surface draw

	private final EstructuraMenu estructuraMenu; // menu struture

	private final SeccionMenu[] secciones; // menu section

	private SeccionMenu seccionActual; // actual section

	public GestorMenu(final SuperficieDibujo sd) { // menu manager
		this.sd = sd;
		...
		final Rectangle etiquetaInventario = new Rectangle( // inventory label
